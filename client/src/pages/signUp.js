    ...
    return (
        <>
            <div className='container col-4 mt-5 line'>
                ...
                <p className='d-flex justify-content-center'>Bem-vindo, financiador!</p>
            ...
            <div className='container col-4'>
                <form>
                    <div className='row'>
                        ...
                        <div className="form-group mt-4 ">
                            <label className="mb-1">Repetir senha</label>
                            <input type="password" className="form-control" />
                        </div>
                    </div>

                    <div className='row m-0 mt-4'>
                        <button type="submit" className="btn btn-dark shadow font-type w-100">Criar conta</button>
                    </div>
                
                    <p className="d-flex justify-content-center mt-5"><a href='?#' className="link">Termos de Contrato e Política de Privacidade</a></p>
